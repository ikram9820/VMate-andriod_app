package com.example.vmate.Models;
...
import com.example.vmate.Interfaces.VideoDownloader;
...
public class FbVideoDownloader implements VideoDownloader {
    ...
    public String createDirectory() throws IOException {
        File folder = new File(Environment.getExternalStorageDirectory() ,"My Video Downloader");
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
            Files.createDirectory(Paths.get(String.valueOf(folder.getAbsoluteFile()))) ;
        }
        else{
            folder.mkdir();
            folder.mkdirs();
